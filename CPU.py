            ...
            # Second Operand Fetch
                ...
                if self.t == 0:
                    ...
                    # CALL Function
                        ...
                        if self.t == 3:
                            ## Load low byte of stack pointer into B
                            self.t = 4
                            self.lbuff[0] = True
                            self.esp[0] = True
                        elif self.t == 4:
                            # Increment lower byte of stack pointer in B
                            self.t = 5
                            #print("SP: " + hex(self.data_bus[0]))
                            self.esp[0] = False
                            self.lbuff[0] = False
                            self.ealu[0] = True
                            self.lsp1[0] = True
                            ...
                            self.t = 6
                            #print("Increment SP: " + hex(self.data_bus[0]))
                            self.ealu[0] = False
                            self.lsp1[0] = False
                            self.esp_b[0] = True
                            self.lbuff[0] = True
